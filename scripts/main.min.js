    ...
    Vue.createApp({
        ...
        data: () => ({
            ...
            experienceItems: [
                ...
                {
                    date: "2024",
                    companyName: { en: "HGS-Hightech Governance Systems", fr: "HGS-Hightech Governance Systems" },
                    jobTitle: { en: "Data Scientist", fr: "Data Scientist" },
                    desc: {
                        en: "Interactive 360-degree product visualization using Deep Learning, TensorFlow, OpenCV, HTML5, and JavaScript to enhance user experience and customer satisfaction.",
                        fr: "Visualisation interactive de produits à 360° utilisant Deep Learning, TensorFlow, OpenCV, HTML5 et JavaScript pour améliorer l'expérience utilisateur et la satisfaction client."
                    }
                },
                {
                    date: "2025",
                    companyName: { en: "National School of Artificial Intelligence and Digitization", fr: "École Nationale d'Intelligence Artificielle et du Digital" },
                    jobTitle: { en: "Team Lead", fr: "Chef d'Équipe" },
                    desc: {
                        en: "Developed a groundbreaking sentiment analysis platform, and under the mentorship of Prof. Asmae Bentaleb. The platform features state-of-the-art ML models, dynamic 3D visualization, and advanced statistical analysis. It empowers businesses to understand customer emotions, track brand sentiment, and make data-driven decisions. Special thanks to Prof. Asmae Bentaleb for her guidance. Ideal for marketing, customer experience, and product development teams.",
                        fr: "Développé une plateforme d'analyse des sentiments révolutionnaire, sous la direction du Prof. Asmae Bentaleb. La plateforme présente des modèles ML de pointe, une visualisation 3D dynamique et une analyse statistique avancée. Elle permet aux entreprises de comprendre les émotions des clients, de suivre les sentiments de la marque et de prendre des décisions basées sur les données. Remerciements spéciaux au Prof. Asmae Bentaleb pour ses conseils. Idéal pour les équipes marketing, expérience client et développement de produits."
                    }
                },
                {
                    date: " ? ",
            ...
            allPortfolioItems: [
                    {
                        ...
                        githubLink: "https://github.com/ennajari/pfe1",
                        deploymentLink: "https://github.com/ennajari/pfe1",
                        screenshots: {
                            img1: {
                    ...
                    },
                    {
                        ...
                        imgUrl: "assets/images/360.png",
                        title: {
                            en: "360° Visualization System",
                            fr: "Système de Visualisation 360°"
                        },
                        date: {
                            en: "2024",
                            fr: "2024"
                        ...
                        desc: {
                            en: "Developed a 360° visualization system during an internship at HGS-Hightech. The project involved implementing deep learning models and integrating them into a web interface for real-time visualization and analysis.",
                            fr: "Développement d'un système de visualisation 360° lors d'un stage chez HGS-Hightech. Le projet a impliqué la mise en œuvre de modèles de deep learning et leur intégration dans une interface web pour la visualisation et l'analyse en temps réel."
                        },
                        category: "Computer Vision",
                        tools: ["Python", "TensorFlow", "OpenCV", "Flask", "Docker", "Git"],
                        githubLink: "https://github.com/yourusername/360-visualization", // Update with your actual GitHub link
                        deploymentLink: "https://your-deployment-link.com", // Update with your actual deployment link
                        screenshots: {
                            img1: {
                                url: "assets/images/350_2.jpg",
                                caption: {
                                    en: "360° visualization interface",
                                    fr: "Interface de visualisation 360°"
                                }
                            },
                            img2: {
                                url: "assets/images/Flower2.png",
                                caption: { 
                                    en: "Deep learning model integration", 
                                    fr: "Intégration du modèle de deep learning" 
                                }
                            },
                            // img3: {
                            //     url: "assets/images/360_visualization3.png",
                            //     caption: { 
                            //         en: "Real-time analysis dashboard", 
                            //         fr: "Tableau de bord d'analyse en temps réel" 
                            //     }
                            // }
                        }
                    },
                    {
                        ...
                        githubLink: "https://github.com/ennajari/3D-Teeth-Classification-Using-ConvNet",
                        deploymentLink: "https://ennajari.github.io/3D-Teeth-Classification-Using-ConvNet/",
                        screenshots: {
                            img1: {
                    ...
                    },
                    {
                        ...
                        githubLink: "https://github.com/ennajari/Customer-Reviews-Classification",
                        deploymentLink: "https://customer-reviews-classification-az8wv9ajwr8ecea2taqzcl.streamlit.app/",
                        screenshots: {
                            img1: {
